        ...
        <div className="space-y-3">
          {paymentOptions.map((option) => (
            <a
              ...
              className="w-full flex items-center p-4 border border-navy-main/30 bg-white rounded-xl cursor-pointer transition hover:border-gate-main hover:bg-gate-main/5 hover:shadow-sm group"
            >
